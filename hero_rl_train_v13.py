"""Train V13: Fire Gem penalty (-0.02), end-game reward, 2M steps."""
import os
...
class CheckpointCallback(BaseCallback):
    ...
    def _on_step(self):
        if self.n_calls % self.save_freq == 0:
            path = os.path.join(self.save_dir, f"v13_{self.n_calls}")
...
print(f"Training V13 for {TOTAL_TIMESTEPS} timesteps...")
...
final_path = os.path.join(CHECKPOINT_DIR, "v13_final")
