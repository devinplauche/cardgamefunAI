...
def apply_action(session, action: dict[str, Any]) -> None:
    ...
    elif action_type == "trigger_ally":
        session.trigger_ally_action(action["cardId"], action.get("stunTargetIndex"))
    elif action_type == "resolve_choice":
        session.resolve_choice_action(int(action["candidateIndex"]))
